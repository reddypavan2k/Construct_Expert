...
<section class=" main">
    <div class="main-header d-flex flex-row justify-content-between">
        <div class="main-section">
            <h6>Teams <span>&#x2794; Update Team</span></h6>
        </div>
    </div>
    <div class="create">
        <form action="update-team" method="post" class="d-flex flex-row">
            <div class="resource-left resource">
                <div class="name">
                    <label for="name">Name :</label>
                    <i class="fa-solid fa-users active-i"></i>
                    <input type="text" id="name" class="name" name="name"
                           placeholder="Enter team name " required value="${team.getName()}">
                </div>
                <div class="type">
                    <label for="type">Job Type :</label>
                    <i class="fa-solid fa-dna"></i>
                    <input type="text" id="type" class="type" name="type"
                           placeholder="Enter team job type " required value="${team.getJobType()}">
                </div>
                <div class="picture">
                    <label for="picture">Picture :</label>
                    <i class="fa-solid fa-image"></i>
                    <input type="url" id="picture" class="picture" name="picture"
                           placeholder="Enter team picture " required value="${team.getPicture()}">
                </div>
            </div>
            <input hidden="hidden" value="${team.getId()}" name="id">
